...
extern void mpi_remote_msg_handle();
extern void mpi_remote_msg_drain();
...
extern void *mpi_blocking_data_rcv(int *data_size_p, nid_t src, xram_memkind_const_t where);
